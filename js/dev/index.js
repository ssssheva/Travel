...
function menuInit() {
  document.addEventListener("click", function(e) {
    const burgerBtn = e.target.closest("[data-fls-menu]");
    const mobileMenu = document.querySelector("body .menu__body");
    if (bodyLockStatus && burgerBtn) {
      bodyLockToggle();
      document.body.toggleAttribute("data-fls-menu-open");
      if (mobileMenu) {
        mobileMenu.focus && mobileMenu.focus();
      }
    }
    if (mobileMenu && document.body.hasAttribute("data-fls-menu-open") && (e.target.closest("body .menu__body .menu__link") || !e.target.closest("body .menu__body") && !burgerBtn)) {
      bodyLockToggle();
      document.body.removeAttribute("data-fls-menu-open");
    }
  });
}
